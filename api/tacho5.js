...
//const ws = new WebSocket('ws://192.168.18.20:3000/'); // Línea comentada original
const ws = new WebSocket('wss://server-floatbin.onrender.com/'); // ¡CORREGIDO AQUÍ!
